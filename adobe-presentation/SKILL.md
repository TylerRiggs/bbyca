...
description: Use this skill whenever creating or editing an Adobe-branded PowerPoint (.pptx) or Word (.docx) document. Triggers on any mention of "deck," "slides," "presentation," "pptx," "Word doc," "document," "one-pager," "leave-behind," "brief," "RFP response," "executive summary," ".docx," or any sales, customer-facing, or internal Adobe collateral that must look authentically Adobe. Covers the Adobe red (#EB1000) + black + white palette, the 14-color extended chart palette, the two-font Adobe Clean system (Adobe Clean Black headlines + Adobe Clean body), exact slide dimensions from Adobe's official 56-layout template, the mandatory left red thread, footer line, voice-and-tone rules, and ready-to-run Python builder scripts — including structured-visual layouts (styled tables with header/total bands, KPI stat cards, card grids, comparison panels, process timelines, callout/notice strips) so structured content is never flattened into generic bullet slides.
---
